...
<body>
   ...
   <div class="form1">
    <form action="signin.php" method="post"  class="form">
        ...
        <div> Username :-<input type="text" name="username"id="text" placeholder="Enter Username"></div>
        ...
        <input type="button" class="button" onclick="location.href='signup2.php'" value="click here"> -->
